...
def send_email(recipient_email, message):
    ...
    body = f'Thank you for your interest in our services. To schedule a property with "{message}", Kindly reply to this email with the date and time you wish to visit.'
...
def send_email_password(recipient_email, message):
    """Send the email"""
    sender_email = 'ntwaribruce647@gmail.com'
    # App password 
    sender_password = 'dnxu aqek mess tcke'
